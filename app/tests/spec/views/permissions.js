      ...
      it('renders relier info', function () {
        return initView('sign_up')
          .then(function () {
            ...
            assert(!! view.$('.privacy-links').text().match(SERVICE_NAME),
              'service name shows in legal block');
            assert(!! view.$('.privacy-links').text().match(SERVICE_URI),
              'service uri shows in legal block');
